...
export class InitialSchema1773502799007 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "auth_code" ("id" SERIAL NOT NULL, "code" character varying NOT NULL, "userId" integer NOT NULL, "redirectUri" character varying NOT NULL, "appId" character varying NOT NULL, "expiresAt" TIMESTAMP NOT NULL, CONSTRAINT "PK_79343e6f9a8993c26d9047b480b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
